...
OpenSpending.Styles.Cofog = {
  ...
  '201': { icon: 'icons/planning.svg', color: '#0099FF', bcolor: '#0AB971' }, // 総務費 総務費
  '3': { icon: 'icons/family.svg', color: '#0099FF', bcolor: '#4E6D00' }, // 民生費
  '301': { icon: 'icons/dollar.svg', color: '#0099FF', bcolor: '#4E6D00' }, // 民生費 民生費
  '4': { icon: 'icons/health.svg', color: '#0099FF', bcolor: '#D33673' }, // 衛生費
  '401': { icon: 'icons/hospital.svg', color: '#0099FF', bcolor: '#D33673' }, // 衛生費 衛生費
  '5': { icon: 'icons/environment.svg', color: '#0099FF', bcolor: '#2A3A03' }, // 労働費
  '501': { icon: 'icons/tree.svg', color: '#0099FF', bcolor: '#2A3A03' }, //　労働費 労働費
  ...
  '801': { icon: 'icons/publicaffairs.svg', color: '#0099FF', bcolor: '#0099FF' }, // 土木費 土木費
  ...
  '1001': { icon: 'icons/education.svg', color: '#0099FF', bcolor: '#790586' }, // 教育費 教育費
  '11': { icon: 'icons/order-safety.svg', color: '#0099FF', bcolor: '#D36B3B' }, // 公債費
  '1101': { icon: 'icons/order-safety.svg', color: '#0099FF', bcolor: '#D36B3B' }, // 公債費 公債費
  '12': { icon: 'icons/order-safety.svg', color: '#0099FF', bcolor: '#935B3B' }, // 諸支出金
  '1201': { icon: 'icons/farms.svg', color: '#0099FF', bcolor: '#935B3B' }, // 諸支出金 諸支出金
  '13': { icon: 'icons/admin.svg', color: '#0099FF', bcolor: '#C35B4B' }, // 予備費
  '1301': { icon: 'icons/admin.svg', color: '#0099FF', bcolor: '#C35B4B' } // 予備費 予備費
};
